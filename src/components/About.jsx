  ...
  return (
    <div className="h-fit relative bg-gradient-to-b from-primary to-transparent pt-4 px-2 xl:px-20">
      ...
      <div className="font-chakra text-base py-8 leading-[5px] xl:mt-4">
        ...
        >
          <b>DARPAN'23</b> the annual techno - cultural fest organised by
          College of Engineering Aranmula, is an exsting event that celebrates
          ...
          mega event is a visual treat for attendies, transporting them to
          another world with a varity of captiving perforamances by aspiring
      ...
      >
        <p className="text-white text-base xl:text-xl font-chakra font-medium">
          ...
          Educaation. <b>CAPE</b> was formed to establish educational
          institutions to provide education and trianing, research and
