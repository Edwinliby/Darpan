    ...
    return (
        <div className='hero xl:hidden py-8 h-fit flex flex-col uppercase justify-center'>
            ...
            <div className='text-white flex flex-col pt-[8rem] uppercase font-extrabold md:ml-[1rem] lg:ml-[2rem] px-5 '>
                <h1 ref={title} className='font-chakra sm:text-2xl opacity-0'>College of Engineering Aranmula Presents</h1>
                <div ref={subtitle} className='font-clash flex flex-wrap opacity-0'>
                    ...
                    <span className='text-main_primary relative top-[-3rem] font-chakra text-stroke-black text-[7rem] md:text-[9rem]'>2023</span>
                </div>
                <span ref={subtitle2} className='opacity-0 relative top-[-5rem] text-[3.5rem] sm:text-[5rem] md:text-[7rem] font-clash'>TECH FEST</span>
            </div>
