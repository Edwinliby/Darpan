...
export default function EventSlider() {
    ...
    return (
        <div className='flex flex-col items-center justify-center h-fit pb-[80px] bg-gradient-to-b from-transparent to-primary'>
            <h1 className='text-[2.7rem] md:text-[4rem] text-white font-clash font-bold tracking-wider uppercase'>Highlights</h1>
            <div className='flex flex-wrap gap-8 md:gap-16 lg:gap-20 pt-10 items-center justify-center px-10 '>
                ...
                <div data-tilt className='w-fit relative scale-105'>
                    <div className='updown'>
                        <div className="flex items-center justify-center w-full h-[22rem] xl:h-[30rem] rounded-sm bg-main_primary/50 backdrop:blur-xl hover:-skew-x-6 skew-y-3 transition-all duration-300 ease-in-out">
                            <div className='w-full h-[22rem] xl:h-[30rem] rounded-sm  bg-gray hover:skew-x-6 hover:scale-105 transition-all duration-300 ease-in-out'>
                                <span className='text-3xl font-clash font-semibold px-4 py-2 absolute left-[-2rem] top-4 bg-main_primary text-white'>DJ NIGHT</span>
                                <Image src="/dj.jpg"
                                    alt="dj"
                                    width={500}
                                    height={500}
                ...
                <div data-tilt className='w-fit relative scale-105'>
                    <div className='updown'>
                        <div className="flex items-center justify-center w-full h-[22rem] xl:h-[30rem] rounded-sm bg-main_primary/50 backdrop:blur-xl hover:-skew-x-6 skew-y-3 transition-all duration-300 ease-in-out">
                            <div className='w-full h-[22rem] xl:h-[30rem] rounded-sm  bg-gray hover:skew-x-6 hover:scale-105 transition-all duration-300 ease-in-out'>
                                <span className='text-3xl font-clash font-semibold px-4 py-2 absolute left-[-2rem] top-4 bg-main_primary text-white'>SPIRE TALK</span>
                                <Image src="/spire2.png"
                                    alt="talk show"
                                    width={500}
                                    height={500}
                                    className='w-full h-full object-cover'
