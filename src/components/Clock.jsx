...
function Clock() {
    return (
        <div className='w-screen flex'>
            ...
            <div className='hidden xl:block pl-4 border grow-[1] min-w-min-[3rem] border-gray/50 p-3 mt-[8rem] text-white'>
                <div className='flex flex-col gap-2 justify-center items-center h-[100%]'>
                    <span className='font-chakra text-[1.8rem]'>2023 <span className='font-clash'>April</span></span>
