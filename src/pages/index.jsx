    ...
    <div className="bg-soothing_black h-fit">
      ...
      <section className=" text-white pt-4" id='events'>
        <div className="relative">
          <div className='relative top-[-1rem] px-2 xl:px-8 flex justify-end w-full font-clash font-bold text-primary'>
          ...
          <div className="flex flex-wrap relative py-8 xl:py-10 items-center justify-center gap-8">
            {posts.map(post =>
              <div className="relative"
                key={post.id}>
                <div className="bg-slate-200 w-21rem h-[20rem] flex items-center justify-center rounded-2xl hover:scale-105 hover:shadow-3xl hover:shadow-primary transform transition duration-500 ease-in-out">
                  <Image
                    src={post.img}
                    width={500}
                    height={500}
